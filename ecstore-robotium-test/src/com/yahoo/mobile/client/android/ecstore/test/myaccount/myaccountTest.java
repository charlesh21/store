...
public class myaccountTest extends ActivityInstrumentationTestCase2<ECStoreActivity> {
    ...
    public void testMyAccounloginNormal() {
    	String[] MyEcouponlogin = {"登出","確定","我的帳戶","tw_store_user76"};
        ...
        solo.waitForText("tw_store_user76", 1, 2000);
        assertTrue(solo.searchText("tw_store_user76"));
    }
    //1961795
    @Smoke
    public void testMyAccounProductCollection() {
        ...
        String[] MyCollectio = {"商品收藏","東京著衣","450"};
    	...
    	solo.waitForText("東京著衣", 1, 2000);
        solo.clickOnText("東京著衣");
        solo.goBack();
        assertTrue(solo.searchText(MyCollectio[1]));
    }
}
