...
public class Action {
    ...
    public static void setSmallPhotoViewStyleAfterSearch(Solo solo) throws Exception{
    ...
    public static void setLargePhotoViewStyleAfterSearch(Solo solo) throws Exception{
